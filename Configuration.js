...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  endpoints.addEndpoint("1", "System Temperature", endpointType.temperatureSensor);
  var e = endpoints.addEndpoint("2", "CPU Load", endpointType.genericSensor);
  e.variableTypeId = 1267
}
